...
export default function ListadoOportunidadModal( props ) {
    ...
    function get_data() {
        httpRequest( 'get', apiServices.apioportunidadoportunidad_index, {
            ...
            if ( result.resp === 1 ) {
                setArrayData( result.arrayOportunidad );
...
ListadoOportunidadModal.propTypes = {
    visible: PropTypes.bool,
    onClose: PropTypes.func,
    onSelect: PropTypes.func,
};

ListadoOportunidadModal.defaultProps = {
    onSelect: () => {},
    visible: false,
};
