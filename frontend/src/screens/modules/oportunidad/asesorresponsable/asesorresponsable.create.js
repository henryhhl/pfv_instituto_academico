...
function CreateAsesorResponsable( props ) {
            ...
            <PaperComponent>
                <CardComponent
                    ...
                    footer={
                        <>
                            <ButtonComponent
                                onClick={ () => props.onStore(asesorResponsable, onBack) }
                            >
                                Guardar
                            </ButtonComponent>
                            <ButtonComponent
...
const mapDispatchToProps = {
    ...
    onCreate: AsesorResponsableActions.onCreate,
    ...
    onStore: AsesorResponsableActions.onGrabar,
};

export default connect(mapStateToProps, mapDispatchToProps)( CreateAsesorResponsable );
