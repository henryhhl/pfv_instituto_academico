            ...
            <PaperComponent>
                <CardComponent
                    ...
                    footer={
                        <>
                            <ButtonComponent
                                onClick={ () => props.onStore(negocio, onBack) }
                            >
                                Guardar
                            </ButtonComponent>
                            <ButtonComponent
...
const mapDispatchToProps = {
    ...
    onCreate: NegocioActions.onCreate,
...
export default connect(mapStateToProps, mapDispatchToProps)( CreateNegocio );
