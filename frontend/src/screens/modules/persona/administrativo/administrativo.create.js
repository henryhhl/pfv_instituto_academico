            ...
            <PaperComponent>
                <CardComponent
                    ...
                    footer={
                        <>
                            <ButtonComponent
                                onClick={ () => props.onStore(administrativo, onBack) }
                            >
                                Guardar
                            </ButtonComponent>
                            <ButtonComponent
...
const mapDispatchToProps = {
    ...
    onStore: AdministrativoActions.onGrabar,
};

export default connect(mapStateToProps, mapDispatchToProps)( CreateAdministrativo );
