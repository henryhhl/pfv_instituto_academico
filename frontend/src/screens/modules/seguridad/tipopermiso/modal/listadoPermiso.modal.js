...
export default function ListadoTipoPermisoModal( props ) {
    ...
    function get_data() {
        httpRequest( 'get', apiServices.apiseguridadtipopermiso_index, {
        } ) . then( (result) => {
            if ( result.resp === 1 ) {
...
ListadoTipoPermisoModal.propTypes = {
    visible: PropTypes.bool,
    onClose: PropTypes.func,
    onSelect: PropTypes.func,
};

ListadoTipoPermisoModal.defaultProps = {
    onSelect: () => {},
    visible: false,
};
